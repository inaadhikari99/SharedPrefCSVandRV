package com.secret.sharedprefrecycle;
...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        holder.tn.setText(studentsDataList.get(position).getName());

        holder.ta.setText(studentsDataList.get(position).getAddress());
        holder.tf.setText(studentsDataList.get(position).getFaculty());
        holder.ts.setText(studentsDataList.get(position).getSemester());
    }
